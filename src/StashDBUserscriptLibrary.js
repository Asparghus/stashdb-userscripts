    ...
    const stashdb = function () {
        ...
        class StashDB extends EventTarget {
            constructor({ pageUrlCheckInterval = 50, logging = false } = {}) {
                super();
                this.stashUrl = 'http://10.0.0.100:6969';
                this.loggedIn = false;
                this.userName = null;
                    ...
                    if (this.loggedIn && !document.querySelector('.settings-box')) {
                        ...
                        const settingsMenuEl = createElementFromHTML(`<div class="box settings-box bg-dark" style="display: none;">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input id="address" class="input" type="text" placeholder="Stash Address (http://10.0.0.100:6969)" value="">
                                </div>
                            </div>
                        ...
                        this.stashUrl = await GM.getValue('stashAddress', 'http://10.0.0.100:6969');
                        ...
                        stashAddress.addEventListener('change', async () => {
                            await GM.setValue('stashAddress', stashAddress.value || 'http://10.0.0.100:6969');
                        });
